...
<main class="main">
    ...
    <div class="about">
        <div class="container">
            <div class="about__in">
                <h2 class="about__head section__title line-before">Клиника</h2>
                ...
                <div class="about__body">
                    <div class="about__body_content">
                        ...
                        <a href="<?php echo home_url('/o-klinike'); ?>" class="about__body_content_link">
                            <div class="about__body_content_link_text">подробнее</div>
        ...
        <div class="container">
            <div class="problem-solution__inner">
                ...
                <div class="problem-solution__subhead">
                    <a href="<?php echo home_url('/problemy-i-resheniya'); ?>" class="arrow-link dark">
                ...
                <div class="problem-solution__body">
                    ...
                    <div class="problem-solution__body_slider swiper">
                        ...
                        <div class="problem-solution__body_slider_wr swiper-wrapper">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#01'); ?>" class="swiper-slide problems__slide">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#02'); ?>" class="swiper-slide problems__slide">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#03'); ?>" class="swiper-slide problems__slide">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#04'); ?>" class="swiper-slide problems__slide">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#05'); ?>" class="swiper-slide problems__slide">
                            ...
                            <a href="<?php echo home_url('/problemy-i-resheniya/#06'); ?>" class="swiper-slide problems__slide">
        ...
        <div class="container">
            <div class="services-team__in">
                <div class="services-team__head">
                    <h2 class="services-team__head_title section__title dark line-before">Специалисты Gradusy Clinic</h2>
